    ...
    const CONTROL_SCHEMA = [
      // --- Station ID: chassis -------------------------------------------
      { key: 'logo.shape', label: "Shape", preset: 'logoShape', control: null, type: 'enum', section: 'logo', tier: 'basic',
        options: ['squircle', 'circle', 'pill', 'shield', 'diamond'], default: 'squircle', invalidates: 'logo' },
      { key: 'logo.size', label: "Size", preset: 'logoSize', control: 'sld-logo-size', type: 'px', section: 'logo', tier: 'basic',
        min: 40, max: 180, step: 1, default: 88, apply: cssVar('--cg-logo-size', 'px'), invalidates: 'logo' },
      { key: 'logo.radius', label: "Corner radius", preset: 'logoRadius', control: 'sld-logo-radius', type: 'px', section: 'logo', tier: 'basic',
        min: 0, max: 60, step: 1, default: 54, invalidates: 'logo',
        when: function (s) { return s['logo.shape'] === 'squircle'; } },
      { key: 'logo.extrusion', label: "Surface", preset: 'logoExtrusion', control: 'sel-logo-extrusion', type: 'enum', section: 'logo', tier: 'advanced',
        options: ['convex', 'concave', 'flat', 'inset'], default: 'convex', invalidates: 'logo' },
      { key: 'logo.microBorder', label: "Rim border", preset: 'microBorder', control: 'chk-logo-microborder', type: 'bool', section: 'logo', tier: 'advanced',
        default: true, invalidates: 'logo' },

      // --- Station ID: surface -------------------------------------------
      { key: 'logo.base', label: "Base colour", preset: 'logoBase', control: 'col-logo-base', type: 'color', section: 'logo.surface', tier: 'basic',
        default: '#702177', invalidates: 'logo' },
      { key: 'logo.grad', label: "Gradient end", preset: 'logoGrad', control: 'col-logo-grad', type: 'color', section: 'logo.surface', tier: 'advanced',
        default: '#46104c', invalidates: 'logo' },
      { key: 'logo.specular', label: "Highlight", preset: 'logoSpecular', control: 'col-logo-specular', type: 'color', section: 'logo.surface', tier: 'advanced',
        default: '#f0f5fc', invalidates: 'logo' },
      { key: 'logo.shadow', label: "Shadow", preset: 'logoShadow', control: 'col-logo-shadow', type: 'color', section: 'logo.surface', tier: 'advanced',
        default: '#18031d', invalidates: 'logo' },
      { key: 'logo.lightAngle', label: "Light angle", preset: 'lightAngleDeg', control: 'sld-logo-grad-angle', type: 'deg', section: 'logo.surface', tier: 'advanced',
        min: 0, max: 360, step: 1, default: 135, invalidates: 'logo' },
      { key: 'logo.shadowBlur', label: "Shadow blur", preset: 'shadowBlurPx', control: 'sld-logo-blur', type: 'px', section: 'logo.surface', tier: 'advanced',
        min: 0, max: 25, step: 1, default: 18, invalidates: 'logo' },

      // --- Station ID: placement -----------------------------------------
      { key: 'logo.pos.top', label: "Top", preset: 'logoTopPx', control: 'sld-logo-top', type: 'px', section: 'logo.position', tier: 'basic',
        min: 10, max: 400, step: 1, default: 60, apply: cssVar('--cg-logo-top', 'px'), invalidates: 'logo' },
      { key: 'logo.pos.left', label: "Left", preset: 'logoLeftPx', control: 'sld-logo-left', type: 'px', section: 'logo.position', tier: 'basic',
        min: 10, max: 600, step: 1, default: 60, apply: cssVar('--cg-logo-left', 'px'), invalidates: 'logo' },

      // --- Wordmark -------------------------------------------------------
      { key: 'wordmark.text', label: "Wordmark", preset: 'wordmark', control: 'txt-logo-content', type: 'text', section: 'wordmark', tier: 'basic',
        default: 'SITIA', invalidates: 'logo' },
      { key: 'wordmark.font', label: "Wordmark font", preset: 'logoFont', control: 'sel-logo-font', type: 'enum', section: 'wordmark', tier: 'basic',
      ...
      { key: 'wordmark.size', label: "Wordmark size", preset: 'wordmarkSizePx', control: 'sld-logo-text-size', type: 'px', section: 'wordmark', tier: 'advanced',
        min: 16, max: 64, step: 1, default: 40, invalidates: 'logo' },
      { key: 'wordmark.x', label: "Wordmark X", preset: 'wordmarkX', control: 'sld-logo-text-x', type: 'px', section: 'wordmark', tier: 'advanced',
        min: -40, max: 40, step: 1, default: 0, invalidates: 'logo' },
      { key: 'wordmark.y', label: "Wordmark Y", preset: 'wordmarkY', control: 'sld-logo-text-y', type: 'px', section: 'wordmark', tier: 'advanced',
        min: -40, max: 40, step: 1, default: 0, invalidates: 'logo' },
      { key: 'wordmark.color', label: "Wordmark colour", preset: 'logoTextColor', control: 'col-logo-text', type: 'color', section: 'wordmark', tier: 'advanced',
        default: '#f7edf9', invalidates: 'logo' },
      { key: 'wordmark.shadowColor', label: "Wordmark shadow", preset: 'logoTextShadowColor', control: 'col-logo-textshadow', type: 'color', section: 'wordmark', tier: 'advanced',
        default: '#200324', invalidates: 'logo' },
      { key: 'wordmark.subtitle', label: "Subtitle", preset: 'subtitle', control: 'txt-logo-subtitle', type: 'text', section: 'wordmark', tier: 'basic',
        default: 'HD', invalidates: 'subtitle' },

      // --- Rating badge ----------------------------------------------------
      { key: 'badge.shape', label: "Badge shape", preset: 'badgeShape', legacy: ['ratingShape'], control: null, type: 'enum', section: 'badge', tier: 'basic',
        options: ['circle', 'squircle', 'pill'], default: 'circle', invalidates: 'badge' },
      { key: 'badge.size', label: "Badge size", preset: 'badgeSizePx', legacy: ['ratingSize'], control: 'sld-rating-size', type: 'px', section: 'badge', tier: 'basic',
        min: 36, max: 100, step: 1, default: 54, apply: cssVar('--cg-badge-size', 'px'), invalidates: 'badge' },
      { key: 'badge.fontSize', label: "Numeral size", preset: 'badgeFontSizePx', legacy: ['ratingFontSize'], control: 'sld-rating-font-size', type: 'px', section: 'badge', tier: 'basic',
        min: 16, max: 42, step: 1, default: 27, apply: cssVar('--cg-badge-font-size', 'px'), invalidates: 'badge' },
      { key: 'badge.cutout', label: "Cut-out", preset: 'ratingCutout', control: 'sel-rating-cutout', type: 'enum', section: 'badge', tier: 'advanced',
      ...
      { key: 'badge.stencil.x', label: "Numeral X", preset: 'stencilOffsetX', control: 'sld-rating-text-x', type: 'px', section: 'badge', tier: 'advanced',
        min: -20, max: 20, step: 1, default: 0, invalidates: 'badge' },
      { key: 'badge.stencil.y', label: "Numeral Y", preset: 'stencilOffsetY', control: 'sld-rating-text-y', type: 'px', section: 'badge', tier: 'advanced',
        min: -20, max: 20, step: 1, default: 0, invalidates: 'badge' },
      // Null means "follow the blueprint"; a hex means the operator overrode it.
      { key: 'badge.tint', label: "Fill tint", preset: 'badgeTint', control: 'col-rating-tint', type: 'color', section: 'badge', tier: 'advanced',
        nullable: true, default: null, invalidates: 'badge' },
      { key: 'badge.rim', label: "Rim stroke", preset: 'badgeRim', control: 'col-rating-stroke', type: 'color', section: 'badge', tier: 'advanced',
        nullable: true, default: null, invalidates: 'badge' },
      ...
      { key: 'badge.font', label: "Broadcast font", preset: 'ratingFont', control: 'sel-rating-font', type: 'enum', section: 'badge', tier: 'basic',
        ingest: function (v) { return fontKeyFromCss(v); },
        options: ['system', 'roboto', 'mono', 'outfit', 'inter', 'montserrat', 'serif'], default: 'system', invalidates: 'badge' },

      // --- Banner ----------------------------------------------------------
      { key: 'banner.font.explanation', label: "Explanation size", preset: 'explanationFontSizePx', control: 'sld-explanation-font', type: 'px', section: 'banner', tier: 'basic',
        min: 10, max: 22, step: 0.5, default: 13, apply: cssVar('--cg-explanation-font-size', 'px'), invalidates: 'timeline' },
      { key: 'banner.font.body', label: "Descriptor size", preset: 'warningBodyFontSizePx', control: 'sld-warning-body-font', type: 'px', section: 'banner', tier: 'basic',
        min: 9, max: 20, step: 0.5, default: 12, apply: cssVar('--cg-warning-body-font-size', 'px'), invalidates: 'timeline' },
      { key: 'banner.font.lead', label: "Lead size", preset: 'warningLeadFontSizePx', control: 'sld-warning-lead-font', type: 'px', section: 'banner', tier: 'advanced',
        min: 8, max: 16, step: 0.5, default: 10.5, apply: cssVar('--cg-warning-lead-font-size', 'px'), invalidates: 'timeline' },
      { key: 'banner.icon.size', label: "Icon size", preset: 'warningIconSizePx', control: 'sld-warning-icon-size', type: 'px', section: 'banner', tier: 'advanced',
        min: 16, max: 48, step: 1, default: 28, apply: cssVar('--cg-warning-icon-size', 'px'), invalidates: 'timeline' },
      { key: 'banner.accent.start', label: "Accent start", preset: 'accentStart', control: 'col-accent-start', type: 'color', section: 'banner', tier: 'advanced',
        default: '#ffffff', invalidates: 'accent' },
      { key: 'banner.accent.mid', label: "Accent colour", preset: 'accentColor', legacy: ['accentMid'], control: 'col-accent-mid', type: 'color', section: 'banner', tier: 'basic',
        default: '#38bdf8', invalidates: 'accent' },
      { key: 'banner.accent.height', label: "Accent thickness", preset: 'accentLineHeightPx', control: 'sld-accent-line-height', type: 'px', section: 'banner', tier: 'advanced',
        min: 1, max: 6, step: 0.5, default: 2, invalidates: 'accent' },
      { key: 'banner.customText', label: "Custom banner text", preset: 'customText', control: 'txt-custom-advisory', type: 'text', section: 'banner', tier: 'basic',
        default: '', invalidates: 'timeline' },

      // --- Banner copy: the lead line and the four descriptor phrasings -----
      { key: 'banner.text.lead', label: "Lead line", preset: 'descriptorTexts.lead', control: 'txt-warn-lead', type: 'text', section: 'banner.copy', tier: 'basic',
        default: 'ΤΟ ΠΡΟΓΡΑΜΜΑ ΠΕΡΙΕΧΕΙ', invalidates: 'timeline' },
      { key: 'banner.text.violence', label: "Violence wording", preset: 'descriptorTexts.violence', control: 'txt-warn-violence', type: 'text', section: 'banner.copy', tier: 'basic',
        default: 'ΣΚΗΝΕΣ ΒΙΑΣ', invalidates: 'timeline' },
      { key: 'banner.text.drugs', label: "Substances wording", preset: 'descriptorTexts.drugs', control: 'txt-warn-drugs', type: 'text', section: 'banner.copy', tier: 'basic',
        default: 'ΧΡΗΣΗ ΟΥΣΙΩΝ', invalidates: 'timeline' },
      { key: 'banner.text.sex', label: "Sex wording", preset: 'descriptorTexts.sex', control: 'txt-warn-sex', type: 'text', section: 'banner.copy', tier: 'basic',
        default: 'ΣΕΞ', invalidates: 'timeline' },
      { key: 'banner.text.language', label: "Language wording", preset: 'descriptorTexts.language', control: 'txt-warn-language', type: 'text', section: 'banner.copy', tier: 'basic',
        default: 'ΑΚΑΤΑΛΛΗΛΗ ΦΡΑΣΕΟΛΟΓΙΑ', invalidates: 'timeline' },

      // --- Layout -----------------------------------------------------------
      { key: 'layout.margin.top', label: "Top margin", preset: 'topOffsetPx', control: 'sld-top-margin', type: 'px', section: 'layout', tier: 'basic',
        min: 20, max: 160, step: 1, default: 60, invalidates: 'layout' },
      { key: 'layout.margin.side', label: "Side margin", preset: 'rightOffsetPx', control: 'sld-right-margin', type: 'px', section: 'layout', tier: 'basic',
        min: 20, max: 180, step: 1, default: 60, invalidates: 'layout' },
      { key: 'layout.textOffsetY', label: "Banner vertical offset", preset: 'textOffsetYPx', control: 'sld-text-offset-y', type: 'px', section: 'layout', tier: 'advanced',
        min: -30, max: 30, step: 1, default: 0, apply: cssVar('--cg-text-offset-y', 'px') },
      { key: 'layout.anchor', label: "Anchor corner", preset: 'anchorPosition', control: null, type: 'enum', section: 'layout', tier: 'basic',
        options: ['top-right', 'top-left', 'bottom-right', 'bottom-left'], default: 'top-right', invalidates: 'layout' },
      { key: 'layout.orientation', label: "Corner order", preset: 'orientation', control: null, type: 'enum', section: 'layout', tier: 'advanced',
        options: ['default', 'flipped'], default: 'default', invalidates: 'timeline' },
      { key: 'layout.displayMode', label: "What is on air", preset: 'displayMode', control: null, type: 'enum', section: 'layout', tier: 'basic',
        options: ['combo', 'rating', 'logo'], default: 'combo', invalidates: 'timeline' },

      // --- Motion ------------------------------------------------------------
      { key: 'motion.hold.rating', label: "Rating hold", preset: 'ratingHoldSec', legacy: ['hold_time'], control: 'sld-rating-hold', type: 's', section: 'motion', tier: 'basic',
        min: 1, max: 60, step: 1, default: 30, invalidates: 'timeline' },
      { key: 'motion.hold.warning', label: "Descriptor hold", preset: 'warningHoldSec', legacy: ['warning_hold_time'], control: 'sld-warning-hold', type: 's', section: 'motion', tier: 'basic',
        min: 1, max: 60, step: 1, default: 30, invalidates: 'timeline' },
      { key: 'motion.curve', label: "Transition", preset: 'motionCurve', control: 'sel-motion-curve', type: 'enum', section: 'motion', tier: 'advanced',
        options: ['elastic', 'smooth', 'fade'], default: 'elastic', invalidates: 'timeline' },

      // --- Look ---------------------------------------------------------------
      { key: 'look.theme', label: "Blueprint", preset: 'themeName', legacy: ['theme'], control: null, type: 'enum', section: 'look', tier: 'basic',
      ...
      { key: 'tag.text.movie', label: "MOVIE text", preset: 'tagTexts.movie', control: 'txt-tag-movie', type: 'text', section: 'tag', tier: 'advanced', invalidates: 'subtitle', default: 'MOVIE TIME' },
